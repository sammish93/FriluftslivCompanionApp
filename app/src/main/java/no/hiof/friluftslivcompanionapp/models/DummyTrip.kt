...
data class DummyTrip(
    ...
    companion object {
        fun getDummyData(): List<DummyTrip> {
            return listOf(
                DummyTrip("Oslo", "Oslo", "Hike", "A challenging mountain hike", "3 hours", 5, "10 km", listOf(LatLng(59.9139, 10.7522))),
                DummyTrip("Bergen", "Vestland", "Climb", "Climbing the famous Ulriken", "5 hours", 4, "7 km", listOf(LatLng(60.3913, 5.3221))),
                DummyTrip("Tromsø", "Troms og Finnmark", "Cross-Country Ski", "Experience the Arctic landscape", "6 hours", 4, "15 km", listOf(LatLng(69.6496, 18.9560))),
                ...
                DummyTrip("Drammen", "Viken", "City Walk", "A relaxing walk along the river", "1 hour", 1, "3 km", listOf(LatLng(59.7425, 10.0119)))
            )
        }
    }
}
